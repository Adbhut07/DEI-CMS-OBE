...
//     setIsLoading(true)
//     try {
//       const response = await fetch(`${process.env.NEXT_PUBLIC_API_ENDPOINT}/api/v1/courses/create`, {
//         method: 'POST',
//         credentials: 'include',
//         headers: {
...
//     setIsLoading(true)
//     try {
//       const response = await fetch(`${process.env.NEXT_PUBLIC_API_ENDPOINT}/api/v1/courses/update/${selectedCourse.id}`, {
//         method: 'PUT',
//         credentials: 'include',
//         headers: {
//           'Content-Type': 'application/json',
...
//       setIsLoading(true)
//       try {
//         const response = await fetch(`${process.env.NEXT_PUBLIC_API_ENDPOINT}/api/v1/courses/delete/${id}`, {
//           method: 'DELETE',
//           credentials: 'include',
//         })
//         if (!response.ok) {
...
//     setIsLoading(true)
//     try {
//       const response = await fetch(`${process.env.NEXT_PUBLIC_API_ENDPOINT}/api/v1/batch/`, {
//         method: 'POST',
//         credentials: 'include',
//         headers: {
//           'Content-Type': 'application/json',
...
export default function CourseManagement() {
  ...
  // Set clientReady on initial mount
  useEffect(() => {
    setClientReady(true)
  }, [])
  ...
  const handleAddBatch = (course: Course) => {
    setSelectedCourseForBatch(course)
    setBatchYear(new Date().getFullYear() + 1)
    setIsBatchModalOpen(true)
  }
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {/* Course Modal - only render when clientReady */}
      {clientReady && isAddModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg w-full max-w-md">
            <h2 className="text-xl font-bold mb-4">
              {selectedCourse ? 'Edit Course' : 'Add New Course'}
      ...
      {/* Batch Modal - only render when clientReady */}
      {clientReady && isBatchModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg w-full max-w-md">
            <h2 className="text-xl font-bold mb-4">
              Add New Batch for {selectedCourseForBatch?.courseName}
