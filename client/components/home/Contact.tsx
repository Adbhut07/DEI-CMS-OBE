      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-300 mb-12">
            Have questions or interested in working with me? Fill out the form below or use the direct contact information provided.
          </p>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">123 Innovation Street</p>
              ...
              <div className="mt-12">
                ...
                <div className="flex gap-4">
                  <a href="#" className="p-3 bg-gray-800 hover:bg-blue-600 rounded-full transition-colors">
