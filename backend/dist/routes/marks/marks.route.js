...
router.get('getStudent-subjectMarks/:studentId/:subjectId', (0, roleMiddleware_1.roleMiddleware)(['Admin', 'HOD', 'Dean', 'Faculty']), marks_controller_1.getStudentSubjectMarks);
router.get('/getExamMarks/:examId', (0, roleMiddleware_1.roleMiddleware)(['Admin', 'HOD', 'Dean', 'Faculty']), marks_controller_1.getExamMarks);
